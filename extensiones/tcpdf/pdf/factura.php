		...
		<tr>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Dirección: Kilomtro 20 via Pasto - Ipiales 
					<br>
					El Cebadal
				</div>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Teléfono: 314 743 05 86
					
					<br>
					retazosglamping@gmail.com
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:100px">
				...
				Identificacion: $respuestaCliente[documento]

			</td>

			<td style="border: 1px solid #666; background-color:white; width:240px; text-align:right">
