...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar tipos de actividad</li>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        if($_SESSION["perfil"] == "Administrador"){
                          ...
                          echo '<button class="btn btn-danger btnEliminarTipo" id="'.$value["id"].'"><i class="fa fa-times"></i></button>';
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Agregar tipos de actividades</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaTipo" placeholder="Ingresar tipo de actividad" required>
